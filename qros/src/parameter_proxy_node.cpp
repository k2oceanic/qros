...
void ParameterProxyNode::fetch_and_bind(const std::string &target_ns)
{
...
void ParameterProxyNode::bind_param(const std::string &target_ns, const std::string &param_name, const rcl_interfaces::msg::ParameterValue &value)
{
